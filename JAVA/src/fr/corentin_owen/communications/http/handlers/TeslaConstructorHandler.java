...
/**
 * Class {@link TeslaConstructorHandler}
 *
 * @author Corentin - Owen
 * @version 12/2021
 */
public class TeslaConstructorHandler implements HttpHandler {
     ...
     */
    public TeslaConstructorHandler(char scenario, Socket socket) {
        ...
        switch (message.getId()) {
            ...
            case "informationDelivery":
                if (scenario == 'C') {
                    ...
                    System.out.println(" -> Error during recovering delivery information.");
                }
                break;
            ...
            case "delivery":
                if (scenario == 'C') {
                    ...
                    if (delivererJson != null) {
                        ...
                        HTTPUtils.sendHTTPMessage(t, jsonResponse.toJson().toString());
                        System.out.println("\n -> Car has been delivered to the client. \n");
                    } else {
